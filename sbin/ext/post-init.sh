...
case "${cpustepcount}" in
  ...
  8)
    ...
    ;;
  9)
    echo 1500 1400 1200 1000 800 500 200 100 50 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_available_frequencies
    ;;
  17)
    echo 1500 1400 1300 1200 1100 1000 900 800 700 600 500 400 300 200 100 50 25 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_available_frequencies
    ;;
esac;
