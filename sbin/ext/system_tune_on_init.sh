...
/sbin/busybox chmod 0777 /data/anr -R;
/sbin/busybox chown system:system /data/anr -R;

# ==============================================================
# CLEANING-TWEAKS
# ==============================================================
/sbin/busybox rm -rf /cache/lost+found/* 2> /dev/null;
/sbin/busybox rm -rf /data/tombstones/* 2> /dev/null;
/sbin/busybox rm -rf /data/anr/* 2> /dev/null;
/sbin/busybox chmod 400 /data/tombstones -R;
/sbin/busybox chown drm:drm /data/tombstones -R;
