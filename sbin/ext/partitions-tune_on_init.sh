...
/sbin/busybox mount -o remount,rw,discard,nodev,inode_readahead_blks=2,data=ordered,barrier=0,journal_async_commit,noauto_da_alloc,delalloc,journal_ioprio=5 /data;
