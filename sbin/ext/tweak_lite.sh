...
#
# 				/system/xbin/echo "ondemand" > /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/swappiness;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/oom_kill_allocating_task;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/dirty_expire_centisecs;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/dirty_writeback_centisecs;
...
# 				/system/xbin/echo 2 > /proc/sys/vm/drop_caches
#
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/page-cluster;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/laptop_mode;
...
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/rr_interval;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/dirty_background_ratio;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/dirty_ratio;
...
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/iso_cpu;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/vfs_cache_pressure;
...
#
# 				/system/xbin/echo XXX > /proc/sys/vm/min_free_kbytes;

# sched_latency_ns: Targeted preemption latency for CPU-bound tasks.
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/sched_latency_ns;

# sched_batch_wakeup_granularity_ns: Wake-up granularity for SCHED_BATCH.
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/sched_batch_wakeup_granularity_ns;

# sched_wakeup_granularity_ns: 	Wake-up granularity for SCHED_OTHER.
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/sched_wakeup_granularity_ns;
...
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/sched_compat_yield;
...
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/threads-max;
...
#
# 				/system/xbin/echo XXX > /proc/sys/kernel/msgmni;
...
#
# 				/system/xbin/echo XXX XXX XXX XXX > /proc/sys/kernel/sem;
